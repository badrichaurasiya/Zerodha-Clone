...
function Hero() {
    return ( 
        <div className='container'>
             <div
                  className='row p-5 mt-5 boeder-bottom text-center'>
                    <h1>Pricing</h1>
                    <h3 className='text-muted  mt-3 fs-4'>Modern platforms and apps, ₹0 investments, and flat ₹20 intraday and F&O trades.</h3>
                     </div>
