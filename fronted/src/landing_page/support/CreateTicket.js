        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
               <h1 className='fs-2 '>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=''><i class="fa fa-user-circle" aria-hidden="true"></i>
                   ...
                   <br/>
                   <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}>Client Master Report (CMR) and Depository </a>
                   <br/>
                   <a href="" style={{textDecoration:"none", lineHeight:"2.5"}}> Participant (DP)</a>
                   <br/>
                ...
                <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=''><i class="fa fa-bar-chart" aria-hidden="true"></i>
                    Kite 
                    </h4>
                 ...
                 <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=''> <i class="fa fa-briefcase" aria-hidden="true"></i>
                      Funds
                    </h4>
                 ...
                 <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=''><i class="fa fa-spinner" aria-hidden="true"></i>
                    Console
                    </h4>
                 ...
                 <div className='col-4 p-5 mt-2 mb-2'>
                    <h4 className=''><i class="fa fa-life-ring" aria-hidden="true"></i>
                      Coin
                    </h4>
