         ...
         <div className='container p-3'>
            <div className='row p-5'>
                <div className='col-6 p-5'>
                    ...
                    <p className='text-muted'>Not just an app,but a whole ecosystum.Our investments in 30+ fintech startup offer you tailored seevices specific to your needs</p>
                    <h2 className='fs-4'>Do better with money</h2>
                    <p className='text-muted'>With initiatives like Nudge and Kill Switch, we don't just facilitate transactions, but actively help you do better with you money</p>
                </div>
                <div className='col-6 p-5'>
